...
function updateso(){
		...
		var sostatus = document.getElementById("sostatus").value;
		
		//get item details
		$.ajax({
                    url: 'soedit/updateso',
                    type: 'post',
                    data: {so_id: so_id,instcode:instcode,number_of_students:number_of_students,grad_month:grad_month,grad_day:grad_day,grad_year:grad_year,sem_enrolled:sem_enrolled,acad_year:acad_year,prog_id:prog_id,assigned_to:assigned_to,sostatus:sostatus},
                    success: function(response) {
