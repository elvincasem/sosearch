...
PS FORM No. 001
			...
			<!-- Regular Modal Print PR-->
                <div id="generatepomodal" class="modal bg"  role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
						...
						<input type="hidden" id="prid" value="<?php echo $aprmaindetails['prid'];?>">
                        <div class="col-sm-7">
                            <input type="text" id="aprnomodal"  class="form-control" value="<?php echo $aprmaindetails['aprno'];?>" disabled>
                        </div>

						<label class="col-md-3 control-label text-right" for="state-normal">Mode of Procurement</label>
                        <div class="col-md-7">
                            <input type="text" id="modeofprocurementpo"  class="form-control" value="<?php echo $aprmaindetails['modeofprocurement'];?>">
						...
						<select id="supplierpo" name="example-select2" class="select-select2" style="width: 100%;" data-placeholder="Choose one..">
						<option></option>
						<?php
							foreach($suppliers as $supplierlist):
								
								echo "<option value='".$supplierlist['supplierID']."'>".$supplierlist['supName']."</option>";
			...
			<div class="block full">
				<div class="block-title">
					...
					<button type="button" id="addapr" class="pull-right btn btn-effect-ripple btn-primary" href="#generatepomodal" data-toggle="modal" onclick="generatepo();"><i class="fa fa-print"></i> Generate PO</button>
				</div>
