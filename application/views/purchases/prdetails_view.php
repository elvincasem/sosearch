...
<div class="row">
	...
	<!-- Regular Modal Print APR-->
                <div id="generateaprmodal" class="modal bg" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                           <div class="modal-header">
								
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								<h3 class="modal-title"><strong>Generate APR</strong></h3>
						...
						<label class="col-md-3 control-label text-right">APR Date</label>
                        <div class="col-md-7">
                            <input type="text" id="aprdate" name="example-datepicker3" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" >
                        </div>	
						
						<label class="col-md-3 control-label text-right" for="state-normal">APR No.</label>
                        <div class="col-sm-7">
                            <input type="text" id="aprno"  class="form-control" >
                        </div>
            ...
            <!-- END Input States Block -->
                            ...
                            <div class="modal-footer">
							<button type="button" class="btn btn-effect-ripple btn-primary" onclick="addapr();">Add APR</button>
...
<table border="1" style="border:solid 2px; width:100%;">
	...
	<?php
				...
				foreach ($pr_list_items_canvass as $aprlistitems):
	...
	<br>
						...
						<h4 class="sub-header"></h4>
							<div class="row" >
								<label class="col-md-2 control-label" for="state-normal">Purchase Order</label>
								 ...
								 <label class="col-md-2 control-label" for="state-normal">APR</label>
								 <div class="col-md-3" >
								 <a href="../../apr/details/<?php echo $getrelatedapr['aprid'];?>"><?php echo $getrelatedapr['aprno'];?></a>
								 <?php
									if($getrelatedapr['aprno']==null){
										if($prmaindetails['prstatus']=="APPROVED"){
											$buttonstatus = "";
										}else{
											$buttonstatus = "disabled";
										...
										echo "<button class='btn btn-primary' title='Save Price' href='#generateaprmodal' data-toggle='modal' $buttonstatus><i class='fa fa-refresh'></i> Generate APR</button>";
									}
								 ?>
		...
		<div class="block full">
			...
			<div class="tab-content">
				...
				echo "<td><input type='number' style='width:80px;text-align:center;' value='".$aprlistitems['qty']."' id='pritemqty-".$aprlistitems['pritemsid']."'></td>";
				echo "<td><input type='text' style='width:80px;text-align:center;' value='".$aprlistitems['unit']."' id='pritemunit-".$aprlistitems['pritemsid']."'></td>";
				echo "<td>".$aprlistitems['description']."</td>";
				echo "<td>".$aprlistitems['itemid']."</td>";
