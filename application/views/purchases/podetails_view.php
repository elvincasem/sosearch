...
$totalamount=$totalamount+$amount;
	...
	echo "<td><input class='form-control' id='qty-".$poitemlist['poitemsid']."' type='number' value='".$poitemlist['qty']."'></td>";
	echo "<td>".$poitemlist['description']."</td>";
	...
	echo "<td class='center'> 
					...
					<button class='btn btn-danger notification' id='notification' onClick='deletepoitem(".$poitemlist['poitemsid'].")'><i class='fa fa-times'></i></button>
