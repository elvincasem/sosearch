                    ...
                    <div id="page-content">
						...
						<?php
									foreach($employeeslist as $employees):
										...
										echo "<option value='".$employees['eid']."' $selected>".$employees['fname']." ".$employees['lname']."</option>";
									endforeach;
        ...
        <div class="block-title">
			...
			<a type="button" class="pull-right btn btn-md btn-primary" href="<?=base_url()?>reports/assetissued_download/<?php echo $eid;?>">Export Result XLS</a>
