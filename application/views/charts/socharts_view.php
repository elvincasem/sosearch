                                ...
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <ul class="nav nav-tabs" data-toggle="tabs">
                                            <li class="active"><a href="#block-tabs-home">SO by Status</a></li>
						...
						<div class="col-lg-12">
                                <div class="widget">
                                    <div class="widget-content widget-content-mini themed-background-dark-default text-light text-center">
                                        <i class="fa fa-bar-chart-o"></i> <strong>SO by Status</strong>
                                    </div>
...
echo "<input type='hidden' id='region' value='".$sostatus."'>";
echo "<input type='hidden' id='region_values' value='".$totalsostatus."'>";
