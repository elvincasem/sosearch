...
class Purchaserequest extends CI_Controller
{
	...
	public function details($id)
	{
		...
		//show apr list
		$data['pr_list_items'] = $this->purchaserequest_model->get_pr_items($id);
		$data['pr_list_items_canvass'] = $this->purchaserequest_model->get_list_items_canvass($id);
		...
		$data['getrelatedapr'] = $this->purchaserequest_model->getrelatedapr($id);
		$data['employeeslist'] = $this->employees_model->getemployeeslist();
	...
	public function updateunitprice(){
		...
		$pritemqty = $this->input->post('pritemqty');
		$pritemunit = $this->input->post('pritemunit');
		$availability = $this->input->post('availability');
		
		$this->purchaserequest_model->updateunitprice($pritemsid,$unitprice,$availability,$pritemqty,$pritemunit);
	}
	...
	public function updateallprices(){
		...
		$this->purchaserequest_model->updateallprices($pritemsid,$unitprice,$availability);
	}
	...
	public function addapr(){
		...
		$lastid = $this->purchaserequest_model->saveapr($aprdate,$aprno,$prid,$modeofprocurement);
	...
	public function checkapr(){
		$aprno = $this->input->post('aprno');
		$aprnoitems = $this->purchaserequest_model->checkduplicateapr($aprno);
		echo $aprnoitems;
