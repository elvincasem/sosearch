...
");
		...
		$arrHeader = array('Property No', 'Particulars','Date Acquired','Total Cost','Assigned To','End User','Article','Classification','Account Code','Service','Whereabout','Remarks','Inventory Tag','Barcode','Supplier Name','RAM','HD','Equipment SN','Processor','Processor SN','Monitor SN','Keyboard SN','Mouse SN','Operating System');
