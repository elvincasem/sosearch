...
class Purchaseorder_model extends CI_Model
{
	...
	public function updateunitprice($poitemsid,$unitprice,$qty)
	{
				
		$sql = "update purchase_po_items set unitprice=".$this->db->escape($unitprice).", qty=".$this->db->escape($qty)." where poitemsid=".$this->db->escape($poitemsid)."";
		$this->db->query($sql);
